...
#Test 1
## Get Address Crawler !Failed! (page did not finish loading when program requested)
```{r}
...
## draw a map  !Failed! (page did not finish loading when program requested)
```{r}
...
#Test 2
## Get Address Crawler !successful!
```{r}
#ref : https://blog.gtwang.org/r/rselenium-r-selenium-browser-web-scraping-tutorial/
#      https://blog.csdn.net/Eastmount/article/details/48108259
#      https://blog.gtwang.org/r/rvest-web-scraping-with-r/
